<template>
  <div>
    <div class="card" style="margin-bottom: 10px;">
      <el-input prefix-icon="Search" style="width: 300px; margin-right: 10px" v-model="data.name" placeholder="请输入商品名称"></el-input>
      ...
      <el-table :data="data.tableData" style="width: 100%">
        ...
        <el-table-column prop="img" label="商品图片">
          <template v-slot="scope">
            <el-image style="width: 40px; height: 40px ;border-radius:10px;"  :src="scope.row.img" :preview-src-list="[scope.row.img]" preview-teleported/>
          </template>
        </el-table-column>
